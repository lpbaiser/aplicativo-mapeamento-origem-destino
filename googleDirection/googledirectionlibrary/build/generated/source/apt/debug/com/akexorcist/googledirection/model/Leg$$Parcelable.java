    ...
    implements Parcelable, ParcelWrapper<com.akexorcist.googledirection.model.Leg>
{
    ...
    private com.akexorcist.googledirection.model.Leg readcom_akexorcist_googledirection_model_Leg(android.os.Parcel parcel$$2) {
        ...
        leg$$1 .durationInTraffic = info$$1;
        ...
        leg$$1 .endLocation = coordination$$2;
        ...
        leg$$1 .departureTime = timeInfo$$2;
        ...
        leg$$1 .startLocation = coordination$$3;
    ...
    private com.akexorcist.googledirection.model.Waypoint readcom_akexorcist_googledirection_model_Waypoint(android.os.Parcel parcel$$4) {
        com.akexorcist.googledirection.model.Waypoint waypoint$$0;
        waypoint$$0 = new com.akexorcist.googledirection.model.Waypoint();
        waypoint$$0 .index = parcel$$4 .readInt();
        ...
        waypoint$$0 .interpolation = parcel$$4 .readDouble();
        return waypoint$$0;
    }
    ...
    private void writecom_akexorcist_googledirection_model_Info(com.akexorcist.googledirection.model.Info info$$6, android.os.Parcel parcel$$15, int flags$$1) {
        parcel$$15 .writeString(info$$6 .text);
        parcel$$15 .writeString(info$$6 .value);
    }

    private void writecom_akexorcist_googledirection_model_Waypoint(com.akexorcist.googledirection.model.Waypoint waypoint$$3, android.os.Parcel parcel$$16, int flags$$2) {
        parcel$$16 .writeInt(waypoint$$3 .index);
        if (waypoint$$3 .location == null) {
            parcel$$16 .writeInt(-1);
        } else {
            parcel$$16 .writeInt(1);
            writecom_akexorcist_googledirection_model_Coordination(waypoint$$3 .location, parcel$$16, flags$$2);
        }
        parcel$$16 .writeDouble(waypoint$$3 .interpolation);
    }
    ...
    private void writecom_akexorcist_googledirection_model_TimeInfo(com.akexorcist.googledirection.model.TimeInfo timeInfo$$5, android.os.Parcel parcel$$18, int flags$$4) {
        parcel$$18 .writeString(timeInfo$$5 .text);
        parcel$$18 .writeString(timeInfo$$5 .value);
        parcel$$18 .writeString(timeInfo$$5 .timeZone);
    }
