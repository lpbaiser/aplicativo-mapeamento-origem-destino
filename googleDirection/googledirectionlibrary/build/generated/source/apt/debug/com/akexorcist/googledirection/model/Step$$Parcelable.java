...
@Generated(value = "org.parceler.ParcelAnnotationProcessor", date = "2016-06-07T14:58-0300")
@SuppressWarnings({
    "unchecked",
    "deprecation"
})
    ...
    implements Parcelable, ParcelWrapper<com.akexorcist.googledirection.model.Step>
{
    ...
    private com.akexorcist.googledirection.model.Step readcom_akexorcist_googledirection_model_Step(android.os.Parcel parcel$$2) {
        ...
        step$$1 .endLocation = coordination$$2;
        ...
        step$$1 .startLocation = coordination$$3;
    ...
    private com.akexorcist.googledirection.model.TransitDetail readcom_akexorcist_googledirection_model_TransitDetail(android.os.Parcel parcel$$3) {
        ...
        transitDetail$$0 .stopNumber = parcel$$3 .readString();
        com.akexorcist.googledirection.model.TimeInfo timeInfo$$1;
        if (parcel$$3 .readInt() == -1) {
            timeInfo$$1 = null;
        } else {
            timeInfo$$1 = readcom_akexorcist_googledirection_model_TimeInfo(parcel$$3);
        }
        transitDetail$$0 .arrivalTime = timeInfo$$1;
        com.akexorcist.googledirection.model.StopPoint stopPoint$$1;
        if (parcel$$3 .readInt() == -1) {
            stopPoint$$1 = null;
        } else {
            stopPoint$$1 = readcom_akexorcist_googledirection_model_StopPoint(parcel$$3);
        }
        transitDetail$$0 .departureStopPoint = stopPoint$$1;
        transitDetail$$0 .headsign = parcel$$3 .readString();
        com.akexorcist.googledirection.model.TimeInfo timeInfo$$2;
        if (parcel$$3 .readInt() == -1) {
            timeInfo$$2 = null;
        } else {
            timeInfo$$2 = readcom_akexorcist_googledirection_model_TimeInfo(parcel$$3);
        }
        transitDetail$$0 .departureTime = timeInfo$$2;
        com.akexorcist.googledirection.model.Line line$$1;
        if (parcel$$3 .readInt() == -1) {
            line$$1 = null;
        } else {
            line$$1 = readcom_akexorcist_googledirection_model_Line(parcel$$3);
        }
        ...
        if (parcel$$3 .readInt() == -1) {
            ...
            stopPoint$$2 = readcom_akexorcist_googledirection_model_StopPoint(parcel$$3);
        }
        transitDetail$$0 .arrivalStopPoint = stopPoint$$2;
        return transitDetail$$0;
    }

    private com.akexorcist.googledirection.model.TimeInfo readcom_akexorcist_googledirection_model_TimeInfo(android.os.Parcel parcel$$4) {
        com.akexorcist.googledirection.model.TimeInfo timeInfo$$0;
        timeInfo$$0 = new com.akexorcist.googledirection.model.TimeInfo();
        timeInfo$$0 .text = parcel$$4 .readString();
        timeInfo$$0 .value = parcel$$4 .readString();
        timeInfo$$0 .timeZone = parcel$$4 .readString();
        return timeInfo$$0;
    }

    private com.akexorcist.googledirection.model.StopPoint readcom_akexorcist_googledirection_model_StopPoint(android.os.Parcel parcel$$5) {
        ...
        stopPoint$$0 .name = parcel$$5 .readString();
        return stopPoint$$0;
    }

    private com.akexorcist.googledirection.model.Coordination readcom_akexorcist_googledirection_model_Coordination(android.os.Parcel parcel$$6) {
        ...
        coordination$$0 .longitude = parcel$$6 .readDouble();
        coordination$$0 .latitude = parcel$$6 .readDouble();
        return coordination$$0;
    }

    private com.akexorcist.googledirection.model.Line readcom_akexorcist_googledirection_model_Line(android.os.Parcel parcel$$7) {
        com.akexorcist.googledirection.model.Line line$$0;
        line$$0 = new com.akexorcist.googledirection.model.Line();
        line$$0 .textColor = parcel$$7 .readString();
        line$$0 .color = parcel$$7 .readString();
        int int$$0 = parcel$$7 .readInt();
        ...
        if (int$$0 < 0) {
            ...
            for (int int$$1 = 0; (int$$1 <int$$0); int$$1 ++) {
                ...
                if (parcel$$7 .readInt() == -1) {
                    ...
                    agency$$1 = readcom_akexorcist_googledirection_model_Agency(parcel$$7);
                }
                list$$0 .add(agency$$1);
            }
        }
        ...
        if (parcel$$7 .readInt() == -1) {
            ...
            vehicle$$1 = readcom_akexorcist_googledirection_model_Vehicle(parcel$$7);
        }
        line$$0 .vehicle = vehicle$$1;
        line$$0 .name = parcel$$7 .readString();
        line$$0 .shortName = parcel$$7 .readString();
        return line$$0;
    }

    private com.akexorcist.googledirection.model.Agency readcom_akexorcist_googledirection_model_Agency(android.os.Parcel parcel$$8) {
        com.akexorcist.googledirection.model.Agency agency$$0;
        agency$$0 = new com.akexorcist.googledirection.model.Agency();
        agency$$0 .name = parcel$$8 .readString();
        agency$$0 .url = parcel$$8 .readString();
        return agency$$0;
    }

    private com.akexorcist.googledirection.model.Vehicle readcom_akexorcist_googledirection_model_Vehicle(android.os.Parcel parcel$$9) {
        com.akexorcist.googledirection.model.Vehicle vehicle$$0;
        vehicle$$0 = new com.akexorcist.googledirection.model.Vehicle();
        vehicle$$0 .name = parcel$$9 .readString();
        vehicle$$0 .iconUrl = parcel$$9 .readString();
        vehicle$$0 .type = parcel$$9 .readString();
        return vehicle$$0;
    }

    private com.akexorcist.googledirection.model.Info readcom_akexorcist_googledirection_model_Info(android.os.Parcel parcel$$10) {
        com.akexorcist.googledirection.model.Info info$$0;
        info$$0 = new com.akexorcist.googledirection.model.Info();
        info$$0 .text = parcel$$10 .readString();
        info$$0 .value = parcel$$10 .readString();
        return info$$0;
    }
    ...
    private void writecom_akexorcist_googledirection_model_TransitDetail(com.akexorcist.googledirection.model.TransitDetail transitDetail$$2, android.os.Parcel parcel$$13, int flags$$1) {
        parcel$$13 .writeString(transitDetail$$2 .stopNumber);
        if (transitDetail$$2 .arrivalTime == null) {
            parcel$$13 .writeInt(-1);
        } else {
            parcel$$13 .writeInt(1);
            writecom_akexorcist_googledirection_model_TimeInfo(transitDetail$$2 .arrivalTime, parcel$$13, flags$$1);
        }
        if (transitDetail$$2 .departureStopPoint == null) {
            parcel$$13 .writeInt(-1);
        } else {
            parcel$$13 .writeInt(1);
            writecom_akexorcist_googledirection_model_StopPoint(transitDetail$$2 .departureStopPoint, parcel$$13, flags$$1);
        }
        parcel$$13 .writeString(transitDetail$$2 .headsign);
        if (transitDetail$$2 .departureTime == null) {
            parcel$$13 .writeInt(-1);
        } else {
            parcel$$13 .writeInt(1);
            writecom_akexorcist_googledirection_model_TimeInfo(transitDetail$$2 .departureTime, parcel$$13, flags$$1);
        }
        if (transitDetail$$2 .line == null) {
            parcel$$13 .writeInt(-1);
        } else {
            parcel$$13 .writeInt(1);
            writecom_akexorcist_googledirection_model_Line(transitDetail$$2 .line, parcel$$13, flags$$1);
        }
        if (transitDetail$$2 .arrivalStopPoint == null) {
            parcel$$13 .writeInt(-1);
        } else {
            parcel$$13 .writeInt(1);
            writecom_akexorcist_googledirection_model_StopPoint(transitDetail$$2 .arrivalStopPoint, parcel$$13, flags$$1);
        }
    }

    private void writecom_akexorcist_googledirection_model_TimeInfo(com.akexorcist.googledirection.model.TimeInfo timeInfo$$3, android.os.Parcel parcel$$14, int flags$$2) {
        parcel$$14 .writeString(timeInfo$$3 .text);
        parcel$$14 .writeString(timeInfo$$3 .value);
        parcel$$14 .writeString(timeInfo$$3 .timeZone);
    }

    private void writecom_akexorcist_googledirection_model_StopPoint(com.akexorcist.googledirection.model.StopPoint stopPoint$$3, android.os.Parcel parcel$$15, int flags$$3) {
        if (stopPoint$$3 .location == null) {
            parcel$$15 .writeInt(-1);
        } else {
            parcel$$15 .writeInt(1);
            writecom_akexorcist_googledirection_model_Coordination(stopPoint$$3 .location, parcel$$15, flags$$3);
        }
        parcel$$15 .writeString(stopPoint$$3 .name);
    }

    private void writecom_akexorcist_googledirection_model_Coordination(com.akexorcist.googledirection.model.Coordination coordination$$4, android.os.Parcel parcel$$16, int flags$$4) {
        parcel$$16 .writeDouble(coordination$$4 .longitude);
        parcel$$16 .writeDouble(coordination$$4 .latitude);
    }

    private void writecom_akexorcist_googledirection_model_Line(com.akexorcist.googledirection.model.Line line$$2, android.os.Parcel parcel$$17, int flags$$5) {
        parcel$$17 .writeString(line$$2 .textColor);
        parcel$$17 .writeString(line$$2 .color);
        if (line$$2 .agencyList == null) {
            parcel$$17 .writeInt(-1);
        } else {
            parcel$$17 .writeInt(line$$2 .agencyList.size());
            for (com.akexorcist.googledirection.model.Agency agency$$2 : ((java.util.List<com.akexorcist.googledirection.model.Agency> ) line$$2 .agencyList)) {
                if (agency$$2 == null) {
                    ...
                    parcel$$17 .writeInt(1);
                    writecom_akexorcist_googledirection_model_Agency(agency$$2, parcel$$17, flags$$5);
                }
            }
        }
        if (line$$2 .vehicle == null) {
            ...
            parcel$$17 .writeInt(1);
            writecom_akexorcist_googledirection_model_Vehicle(line$$2 .vehicle, parcel$$17, flags$$5);
        }
        parcel$$17 .writeString(line$$2 .name);
        parcel$$17 .writeString(line$$2 .shortName);
    }

    private void writecom_akexorcist_googledirection_model_Agency(com.akexorcist.googledirection.model.Agency agency$$3, android.os.Parcel parcel$$18, int flags$$6) {
        parcel$$18 .writeString(agency$$3 .name);
        parcel$$18 .writeString(agency$$3 .url);
    }

    private void writecom_akexorcist_googledirection_model_Vehicle(com.akexorcist.googledirection.model.Vehicle vehicle$$2, android.os.Parcel parcel$$19, int flags$$7) {
        parcel$$19 .writeString(vehicle$$2 .name);
        parcel$$19 .writeString(vehicle$$2 .iconUrl);
        parcel$$19 .writeString(vehicle$$2 .type);
    }

    private void writecom_akexorcist_googledirection_model_Info(com.akexorcist.googledirection.model.Info info$$3, android.os.Parcel parcel$$20, int flags$$8) {
        parcel$$20 .writeString(info$$3 .text);
        parcel$$20 .writeString(info$$3 .value);
    }
